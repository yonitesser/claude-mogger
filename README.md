...
[![tests](https://img.shields.io/badge/hooks-71%20passing-ff5a1f?style=for-the-badge)](tests/hooks.test.sh)
...
tests/hooks.test.sh     71 assertions. If this fails, the gates don't work.
